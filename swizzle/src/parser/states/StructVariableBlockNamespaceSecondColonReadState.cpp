...
namespace swizzle { namespace parser { namespace states {
    ...
    ParserState StructVariableBlockNamespaceSecondColonReadState::consume(const lexer::TokenInfo& token, NodeStack&, NodeStack&, TokenStack& tokenStack, ParserStateContext&)
    {
