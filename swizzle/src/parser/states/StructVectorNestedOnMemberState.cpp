...
namespace swizzle { namespace parser { namespace states {
    ...
    ParserState StructVectorNestedOnMemberState::consume(const lexer::TokenInfo& token, types::NodeStack&, types::NodeStack&, types::TokenStack& tokenStack, ParserStateContext&)
    {
