...
namespace {
    ...
    struct NamespaceFirstColonStateFixture
    {
        NamespaceFirstColonStateFixture()
        {
            nodeStack.push(ast.root());
        }

        states::NamespaceFirstColonState state;
    ...
    TEST_FIXTURE(NamespaceFirstColonStateFixture, verifyConstruction)
    {
    }

    struct WhenNextTokenIsColon : public NamespaceFirstColonStateFixture
    {
    ...
    struct WhenNextTokenIsInvalid : public NamespaceFirstColonStateFixture
    {
